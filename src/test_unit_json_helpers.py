...
from test_utilities import JSONRequestTestFixtureUtilities, JSONRobotDatabaseDataTextFixtureUtilities
...
class RobotDatabaseJSONTransformerUnitTest(unittest.TestCase):
    ...
    def test_is_robot_database_json_valid_returns_false_when_json_has_wrong_types(self):
        invalid_json_data = JSONRobotDatabaseDataTextFixtureUtilities.get_robot_database_data(robot_id='bad_data')
        is_valid = RobotDatabaseJSONTransformer.is_robot_database_json_valid(invalid_json_data)
        self.assertFalse(is_valid)

        invalid_json_data = JSONRobotDatabaseDataTextFixtureUtilities.get_robot_database_data(battery_level='bad_data')
        is_valid = RobotDatabaseJSONTransformer.is_robot_database_json_valid(invalid_json_data)
        self.assertFalse(is_valid)

        invalid_json_data = JSONRobotDatabaseDataTextFixtureUtilities.get_robot_database_data(x='bad_data')
        is_valid = RobotDatabaseJSONTransformer.is_robot_database_json_valid(invalid_json_data)
        self.assertFalse(is_valid)

        invalid_json_data = JSONRobotDatabaseDataTextFixtureUtilities.get_robot_database_data(y='bad_data')
        is_valid = RobotDatabaseJSONTransformer.is_robot_database_json_valid(invalid_json_data)
        self.assertFalse(is_valid)

    def test_is_robot_database_json_valid_returns_false_when_json_has_wrong_field_names(self):
        invalid_json_data = JSONRobotDatabaseDataTextFixtureUtilities.get_robot_database_data_override_names(
            robot_id_name='wrong_name')
        is_valid = RobotDatabaseJSONTransformer.is_robot_database_json_valid(invalid_json_data)
        self.assertFalse(is_valid)

        invalid_json_data = JSONRobotDatabaseDataTextFixtureUtilities.get_robot_database_data_override_names(
            battery_level_name='wrong_name')
        is_valid = RobotDatabaseJSONTransformer.is_robot_database_json_valid(invalid_json_data)
        self.assertFalse(is_valid)
    ...
    def test_is_robot_database_json_valid_returns_true_when_json_contains_battery_level_from_0_and_100(self):
        invalid_json_data = JSONRobotDatabaseDataTextFixtureUtilities.get_robot_database_data(battery_level=-1)
        is_valid = RobotDatabaseJSONTransformer.is_robot_database_json_valid(invalid_json_data)
        self.assertFalse(is_valid)

        invalid_json_data = JSONRobotDatabaseDataTextFixtureUtilities.get_robot_database_data(battery_level=101)
        is_valid = RobotDatabaseJSONTransformer.is_robot_database_json_valid(invalid_json_data)
        self.assertFalse(is_valid)

        valid_json_data = JSONRobotDatabaseDataTextFixtureUtilities.get_robot_database_data(battery_level=0)
        is_valid = RobotDatabaseJSONTransformer.is_robot_database_json_valid(valid_json_data)
        self.assertTrue(is_valid)

        valid_json_data = JSONRobotDatabaseDataTextFixtureUtilities.get_robot_database_data(battery_level=50)
        is_valid = RobotDatabaseJSONTransformer.is_robot_database_json_valid(valid_json_data)
        self.assertTrue(is_valid)

        valid_json_data = JSONRobotDatabaseDataTextFixtureUtilities.get_robot_database_data(battery_level=100)
        is_valid = RobotDatabaseJSONTransformer.is_robot_database_json_valid(valid_json_data)
        self.assertTrue(is_valid)

    def test_is_robot_database_json_valid_returns_true_when_json_contains_float_battery_level(self):
        valid_json_data = JSONRobotDatabaseDataTextFixtureUtilities.get_robot_database_data(battery_level=50.5)
        is_valid = RobotDatabaseJSONTransformer.is_robot_database_json_valid(valid_json_data)
        self.assertTrue(is_valid)

    def test_is_robot_database_json_valid_returns_true_when_json_contains_x_y_coordinates_of_any_value(self):
        valid_json_data = JSONRobotDatabaseDataTextFixtureUtilities.get_robot_database_data(x=-1,
                                                                                            y=-1)
        is_valid = RobotDatabaseJSONTransformer.is_robot_database_json_valid(valid_json_data)
        self.assertTrue(is_valid)

        valid_json_data = JSONRobotDatabaseDataTextFixtureUtilities.get_robot_database_data(x=0,
                                                                                            y=0)
        is_valid = RobotDatabaseJSONTransformer.is_robot_database_json_valid(valid_json_data)
        self.assertTrue(is_valid)
    ...
    def test_is_robot_database_json_valid_returns_true_when_json_contains_float_x_y_coordinates(self):
        valid_json_data = JSONRobotDatabaseDataTextFixtureUtilities.get_robot_database_data(x=0.9,
                                                                                            y=0.9)
        is_valid = RobotDatabaseJSONTransformer.is_robot_database_json_valid(valid_json_data)
        self.assertTrue(is_valid)

    def test_creates_robot_with_data_from_robot_database_json(self):
        valid_json_data = JSONRobotDatabaseDataTextFixtureUtilities.get_robot_database_data(robot_id=100,
                                                                                            battery_level=28,
                                                                                            x=200,
                                                                                            y=-5)
